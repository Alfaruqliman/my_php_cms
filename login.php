...
<?php require_once("includes/functions.php"); ?>
	<?php
		...
		if (isset($_POST['submit'])) { // Form has been submitted.
			...
			$fields_with_length = array('username' => 30, 'password' => 30);
		...
		if ( empty($errors) ){
			// Check databse to see if username and the hashed password exist ther.
			$query = "SELECT * ";
			$query .= "FROM users ";
			$query .= "WHERE username = '{$username}' ";
			$query .= "WHERE hashed_password = '{$hashed_password}' ";
			$query .= "LIMIT 1";
